...
describe("meeting lifecycle and command schemas", () => {
...
describe("meeting claim and create schemas", () => {
    ...
    it("rejects a new Issue claim without riskLevel", () => {
        expect(() =>
            TurnSubmissionSchema({
                protocolVersion: 1,
                meetingId: "meeting-1",
...
describe("meeting terminal and archive schemas", () => {

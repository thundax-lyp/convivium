    ...
    return [
        {
            ...
            roleDescription: phase === "1" ? "FR14_MANAGER_V1" : "FR14_MANAGER_V2",
            dshPresetId: "minimal",
        ...
        },
        {
            ...
            roleDescription: phase === "1" ? "FR14_PARTICIPANT_V1" : "FR14_PARTICIPANT_V2",
            dshPresetId: "minimal",
            requiredSkillNames: ["fr14-fixture"],
...
export function roleSmokeModelOverrides(phase) {
    if (phase !== "1" && phase !== "2") throw new TypeError("Invalid role smoke phase.");
    return {
        "fr14-manager": {

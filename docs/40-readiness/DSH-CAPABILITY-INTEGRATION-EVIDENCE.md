...
2026-09-08 收口核对：完整验证提交为 `61f7de2`，生产启动修复及五核心 smoke 提交为 `d1bae10`；九步替换任务全部完成。长期结论与失败/恢复证据已迁移，临时执行手册及对应已完成 TODO 删除；删除前后文档目标与残留引用检查通过。历史追溯使用 Git，不保留 completed 手册副本。

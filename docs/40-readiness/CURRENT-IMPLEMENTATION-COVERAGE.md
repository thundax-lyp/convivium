...
| FR-14 共享 Preset 下的 Agent Definition | 首发目标已更新，待实现 | 旧模型已验证内联定义、全角色预检、persona/toolFilter/agentOptions、provenance、重放和双 Host 冷恢复 | 2026-09-08 新目标的 roleDescription、独立 Host 模型绑定、随包九角色/原生 Skills/共享 Preset 及完整部署均未实现或验证；旧证据不能覆盖新首发目标 |

...
前置：HEAD 为已完成 T5 的唯一前一步 commit、clean、T5 已删除。允许：只更新 `docs/40-readiness/CURRENT-IMPLEMENTATION-COVERAGE.md` 的 FR-6 Agenda candidate disposition 行；删除本 RUNBOOK。禁止其他文件。
